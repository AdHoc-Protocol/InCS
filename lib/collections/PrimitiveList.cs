...
public interface PrimitiveList<T> where T : struct{
    ...
    class RW : R, IList<T>{
        ...
        public RW(T defaultValue, int capacity)
        {
            ...
            if( 0 < capacity ) values = new T[capacity];
        }
        ...
        public RW Add(int index, T value)
        {
            ...
            count = BitList.Resize(values, values.Length <= count ?
                                               values = new T[Math.Max(16, count * 3 / 2)] :
        ...
        public RW Count_(int newCount)
        {
            ...
            if( newCount   == 0 ) Clear();
            else if( Count < newCount ) Set(newCount - 1, defaultValue);
            else
                count = newCount;
            return this;
        }
        ...
        public RW Swap(int index1, int index2)
        {
            ...
            if( EqualityComparer<T>.Default.Equals(val1, val2) ) return this;
